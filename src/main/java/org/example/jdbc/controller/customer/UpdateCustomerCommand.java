...
public class UpdateCustomerCommand implements Controller {
  ...
  private void update() {
    ...
    customerService.update(Long.valueOf(id), name, Long.valueOf(budget), Long.valueOf(companyId));
    System.out.println(
        " ✅ You updated \uD83D\uDC49 " + customerService.getById(Long.valueOf(id)).get() + "\n");
  }
  ...
  private String enterId() {
    ...
    if (!Validator.validNumber(id)
        || customerService.getById(Long.valueOf(id)).get().getId() == null) {
