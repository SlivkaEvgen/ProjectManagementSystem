...
import org.homework.config.DatabaseConnection;
import org.homework.repository.interfaces.DeveloperRepository;
...
public class DeveloperRepositoryImpl implements DeveloperRepository {
    ...
    public Developer create(Developer developer) {
        PreparedStatement preparedStatement = CONNECTION.prepareStatement("INSERT INTO " + SCHEMA_NAME + ".developers (name,age,gender,email,number_phone,company_id,salary)" + " VALUES (?,?,?,?,?,?,?)");
    ...
    public Developer update(Long id, Developer developer) {
        PreparedStatement preparedStatement = CONNECTION.prepareStatement("UPDATE " + SCHEMA_NAME + ".developers set name=?, age=?, gender=?, email=?,number_phone =?,company_id=?, salary=? WHERE id=" + id + ";");
        preparedStatement.setString(1, developer.getName());
        preparedStatement.setLong(2, developer.getAge());
        preparedStatement.setString(3, developer.getGender());
        preparedStatement.setString(4, developer.getEmail());
